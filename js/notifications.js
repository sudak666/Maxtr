...
async function enablePushNotifications(){
  if(/** @type {string} */ (VAPID_KEY)==='PASTE_YOUR_VAPID_KEY_HERE'){ showToast(tr('toast_push_no_vapid'),'xmark'); renderNotifUI(); return; }
...
export function populateNotifTimeSelects(){
  const h=/** @type {HTMLSelectElement | null} */ (document.getElementById('notif-time-hour'));
  const m=/** @type {HTMLSelectElement | null} */ (document.getElementById('notif-time-minute'));
...
const updateNotifTimeFromSelects = function(){
  const h=/** @type {HTMLSelectElement | null} */ (document.getElementById('notif-time-hour'))?.value||'21';
  const m=/** @type {HTMLSelectElement | null} */ (document.getElementById('notif-time-minute'))?.value||'00';
...
export function renderNotifUI(){
  const cb=/** @type {HTMLInputElement | null} */ (document.getElementById('notif-toggle-checkbox'));
  ...
  const bcb=/** @type {HTMLInputElement | null} */ (document.getElementById('notif-budget-checkbox'));
  if(bcb) bcb.checked=!!AppState.notifSettings.budgetAlerts;
  const rcb=/** @type {HTMLInputElement | null} */ (document.getElementById('notif-recurring-checkbox'));
  if(rcb) rcb.checked=!!AppState.notifSettings.recurringAlerts;
  const dcb=/** @type {HTMLInputElement | null} */ (document.getElementById('notif-debt-checkbox'));
  if(dcb) dcb.checked=!!AppState.notifSettings.debtAlerts;
  const pcb=/** @type {HTMLInputElement | null} */ (document.getElementById('notif-push-checkbox'));
