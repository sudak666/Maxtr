...
class RytmMigrationTest {
    ...
    @Test
    fun migrate13To15PreservesDataAndCreatesNewSchema() {
        ...
        helper.runMigrationsAndValidate(DB_NAME, 15, true, *RytmMigrations.ALL).use { db ->
            db.query("SELECT amount, comment, monobankId FROM transactions WHERE id = 'tx'").use { cursor ->
