...
Кроки 1-41 повністю закриті й реально перевірені наскрізь. Відкриті пункти: (1) мова (i18n, uk/en) — великий механічний рефакторинг, блокований міграцією сотень хардкоджених рядків у string resources; (2) continuous (не лише cold-sync) синхронізація для всіх доменів; (3) tab-bar tap-анімації (pop/ripple), свідомо відкладені в кроці 41. Запитай власника акаунта перед стартом, який пріоритет.
