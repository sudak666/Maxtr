...
Далі: categoryIcons (чисто оздоблення), recurring (найскладніший з нових доменів — повна форма транзакції + логіка наступної дати), чи решта Settings (мова/Push/профілі)? Працюю строго покроково.
