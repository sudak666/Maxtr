...
**Наступний крок (не вирішено, запитай або вирішуй сам)**: categoryIcons (чисто оздоблення), recurring (найскладніший з нових доменів), чи решта Settings (мова/Push/профілі).
