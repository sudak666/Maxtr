...
- [ ] Split oversized coordinators/ViewModels/sheets; move migration-history comments out of production code. (All migration-history narratives are removed and guarded. Reusable primitives plus Appearance, About and Finance sections are extracted; `SettingsScreen` fell from 1,094 to 800 lines and is capped at 850 by test. Remaining large screens/ViewModels/coordinator cleanup remains.)
