...
- [ ] Split oversized coordinators/ViewModels/sheets; move migration-history comments out of production code. (All migration-history narratives are removed from production Kotlin and a source-contract test prevents regrowth. Reusable Settings primitives are extracted from the former 1,094-line screen; section extraction and wider coordinator/ViewModel cleanup remain.)
