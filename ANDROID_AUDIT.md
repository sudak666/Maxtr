...
- [ ] Split oversized coordinators/ViewModels/sheets; move migration-history comments out of production code. (All migration-history narratives are removed and guarded. Settings fell from 1,094 to 800 lines; pure filtering/monthly totals moved out of `FinanceViewModel`, reducing it from 441 to 402. Both have source-size regression caps and deterministic calculation tests. Remaining large screens/coordinator cleanup remains.)
