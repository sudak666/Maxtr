...
- [ ] Split oversized coordinators/ViewModels/sheets; move migration-history comments out of production code. (Reusable Settings section/card/row/toggle primitives are extracted from the 1,094-line screen. Stale migration narratives are removed from authentication, initial sync, profile IDs, Settings, Debt, navigation and theme sources; remaining references, section extraction and wider coordinator/ViewModel cleanup remain.)
