...
- [ ] Split oversized coordinators/ViewModels/sheets; move migration-history comments out of production code. (Reusable Settings section/card/row/toggle primitives are extracted from the 1,094-line screen; section extraction and the wider coordinator/ViewModel/history-comment cleanup remain.)
