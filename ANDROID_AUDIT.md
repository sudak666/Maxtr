...
- [x] Replace `fallbackToDestructiveMigration` with explicit, tested Room migrations (authoritative v13 schema regenerated from historical commit `1f87df7`; connected 13→17 migration preserves data and validates every later schema/index. v14 was an internal transition and never a published database version.)
